...
Sphere1PhysicsList::Sphere1PhysicsList() :  G4VUserPhysicsList()
{
  ...
  radioactiveDecay = NULL;//new G4RadioactiveDecayPhysics();
...
void Sphere1PhysicsList::ConstructRadioactiveDecay()
{
...
//tmp  theScintillationProcess->SetVerboseLevel(verbose);
