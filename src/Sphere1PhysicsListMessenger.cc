...
Sphere1PhysicsListMessenger::Sphere1PhysicsListMessenger(Sphere1PhysicsList* pPhys)
:pPhysicsList(pPhys)
{
  Sphere1Dir = new G4UIdirectory("/Sphere1/");
  Sphere1Dir->SetGuidance("UI commands of this example");
  
  physDir = new G4UIdirectory("/Sphere1/phys/");
  physDir->SetGuidance("PhysicsList control");
 
  verboseCmd = new G4UIcmdWithAnInteger("/Sphere1/phys/verbose",this);  
  ...
  cerenkovCmd = new G4UIcmdWithAnInteger("/Sphere1/phys/cerenkovMaxPhotons",this);  
...
Sphere1PhysicsListMessenger::~Sphere1PhysicsListMessenger()
{
  delete verboseCmd;
  delete cerenkovCmd;
  delete physDir;
...
void Sphere1PhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{       
